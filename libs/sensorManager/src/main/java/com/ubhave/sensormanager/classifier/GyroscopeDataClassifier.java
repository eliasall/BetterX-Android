...
public class GyroscopeDataClassifier implements SensorDataClassifier
{
	@Override
	public boolean isInteresting(final SensorData sensorData, final SensorConfig sensorConfig)
	{
		GyroscopeData data = (GyroscopeData) sensorData;
		GyroscopeData prevData = (GyroscopeData) sensorData.getPrevSensorData();
...
//		}
		...
		return true;//!areSameLocations(currLoc, prevLoc);
	}
