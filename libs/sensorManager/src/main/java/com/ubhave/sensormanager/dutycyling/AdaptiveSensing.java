...
public class AdaptiveSensing implements SensorDataListener {
    ...
    public void registerSensor(ESSensorManagerInterface sensorManager, SensorInterface sensor,
                               SensorDataClassifier classifier, SleepWindowListener listener, SensorDataListener dataListener) throws ESException {
        ...
        try {
            int subscriptionId = sensorManager.subscribeToSensorData(sensor.getSensorType(), this.dataListener);
    ...
    public void onDataSensed(SensorData data) {
        try {
            int sensorType = data.getSensorType();
            Log.i("phone", "Received from: " + SensorUtils.getSensorName(sensorType));
        } catch (Exception e) {}
